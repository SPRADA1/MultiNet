...
#Directory
setwd("F:/DOCTORADO/TESIS/GSE76938/test")

#Call supplemental scripts containing needed functions
source("F:/DOCTORADO/PROGRAMAS/TESIS PROGRAMS/MultiNet_Supp1_Sep2020.R") 
source("F:/DOCTORADO/PROGRAMAS/TESIS PROGRAMS/MultiNet_Supp2_Sep2020.R") 
...
#Visualize data
#3D plot
selection_dat<-diff_global1[1:2000]
...
##################
#Run the algorithm
multinet(all.dat_ord_global=all.dat_ord_global ,medi_global= medi_global,var_s1=var_s1, diff_global1=diff_global1,
         medi_global_control=medi_global_control,var_s1_control=var_s1_control,
         medi_global_case=medi_global_case,var_s1_case=var_s1_case)
...
multinet(all.dat_ord_global=all.dat_ord_local1 ,medi_global= site_local,var_s1=var_s1_local, diff_global1=medi_local,
